...
class InvisibleWaterMark:
    ...
    def encode(self, image, watermark, result):
        ...
        cv2.imwrite("/home/jeremy/InvWatermark/public/photo/debug_3.png", numpy.real(watermark_random), [int(cv2.IMWRITE_JPEG_QUALITY), 100])
        cv2.imwrite("/home/jeremy/InvWatermark/public/photo/debug_4.png", numpy.real(res), [int(cv2.IMWRITE_JPEG_QUALITY), 100])
